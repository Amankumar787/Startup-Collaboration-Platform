...
const ApplicationSchema = new mongoose.Schema(
  {
    ...
    // Skills applicant is offering for this project
    offeredSkills: {
      type: [String],
      default: [],
    },

    // Founder's response/feedback message (optional)
    founderNote: {
      type: String,
...
// Compound: Founder views all applications for a project by status
ApplicationSchema.index({ project: 1, status: 1 });

// Compound: Developer views their own applications
...
// ─── Pre-save: Set reviewedAt timestamp when status changes ──────────────────
